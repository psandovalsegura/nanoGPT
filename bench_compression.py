...
filename_prefix = f"{activation_strategy.__class__.__name__}_{chosen_submodule.__name__}"
...
if profile:
    ...
    def trace_handler(prof: torch.profiler.profile):
        ...
        title = f"Compression {activation_strategy.__class__.__name__} k={activation_strategy.k}" \
